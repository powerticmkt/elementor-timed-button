<?php
namespace ElementorTimedButton\Widgets;
...
class Elementor_Timed_Button extends Widget_Base {

	public function get_name() {
		return 'elementor-timed-button';
	}

	public function get_title() {
		return __( 'Timed Button', 'elementor-timed-button' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'timer',
				[
					'label' => __( 'Timer', 'elementor' ),
					'type' => Controls_Manager::NUMBER,
					'default' => 5,
					'description' => "Time in seconds until button appear",
				]
		);
	...
	protected function render() {
		...
		jQuery( "<?php echo $this->get_unique_selector(); ?>" ).hide();
		jQuery( "<?php echo $this->get_unique_selector(); ?>" ).delay(<?php echo $settings['timer'] * 1000; ?>).fadeIn();
		</script>
